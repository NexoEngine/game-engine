...
namespace nexo::renderer {
	...
	TEST_F(Renderer3DTest, DrawMesh)
	{
	    ...
	    const auto texture = Texture2D::create(4, 4);
	...
	TEST_F(Renderer3DTest, BeginSceneWithoutInit)
	{
	    ...
	    constexpr glm::mat4 viewProjection = 1.0f;
	    constexpr glm::vec3 cameraPosition = {0.0f, 0.0f, 0.0f};
	...
	TEST_F(Renderer3DTest, DrawCubeWithoutBeginScene)
	{
	    ...
	    constexpr glm::vec3 size = {1.0f, 1.0f, 1.0f};
