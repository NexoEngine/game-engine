...
namespace nexo::renderer
{
    ...
    public:
        ...
        static std::shared_ptr<NxVertexArray> getCylinderVAO(unsigned int nbSegment = 8);
        static std::shared_ptr<NxVertexArray> getSphereVAO(unsigned int nbSubdivision = 1);
