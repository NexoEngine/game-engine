...
namespace nexo::renderer {
    ...
    class NxSubTexture2D {
       public:
        ...
        /**
         * @brief Retrieves the base texture associated with the subtexture.
         *
         * Returns a shared pointer to the `NxTexture2D` that this subtexture is derived from.
         * This allows access to the original texture for rendering or other operations.
         *
         * @return A constant reference to the shared pointer of the base texture.
         */
        [[nodiscard]] const std::shared_ptr<NxTexture2D> &getTexture() const
        {
            return m_texture;
        }
         ...
         */
        [[nodiscard]] const glm::vec2 *getTextureCoords() const
        {
            return m_texCoords;
        }
         ...
         */
        static std::shared_ptr<NxSubTexture2D> createFromCoords(const std::shared_ptr<NxTexture2D> &texture,
