...
namespace nexo::renderer {
    ...
    *
    * The `SubTexture2D` class allows defining a sub-region within a larger texture.
    ...
    * Example Usage:
    * ```cpp
    * auto texture = Texture2D::create("path/to/texture.png");
    * auto subTexture = SubTexture2D::createFromCoords(texture, {1, 1}, {64, 64});
    * ```
    */
    class SubTexture2D {
        public:
            /**
            * @brief Constructs a `SubTexture2D` from specified texture coordinates.
            *
            ...
            *
            * @param texture A shared pointer to the base `Texture2D`.
            ...
            */
            ...
            /**
            * @brief Creates a `SubTexture2D` from grid-based coordinates within a texture.
            *
            ...
            * @return A shared pointer to the created `SubTexture2D` instance.
            *
            * Example:
            * ```cpp
            * auto texture = Texture2D::create("path/to/spritesheet.png");
            * auto subTexture = SubTexture2D::createFromCoords(texture, {1, 1}, {64, 64});
            * ```
            *
            * Example Explanation:
