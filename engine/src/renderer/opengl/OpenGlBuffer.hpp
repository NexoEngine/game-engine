...
namespace nexo::renderer {
    ...
    class NxOpenGlVertexBuffer final : public NxVertexBuffer {
       public:
         ...
         *
         * This method defines the layout of the vertex data stored in the buffer.
         * The layout specifies how vertex attributes are organized, including their
         * types, sizes, and offsets.
         *
         * @param layout The `NxBufferLayout` object that describes the vertex data layout.
         *
         * Usage:
         * - Call this method after creating the buffer and before rendering to ensure
         *   correct interpretation of vertex data.
         */
        void setLayout(const NxBufferLayout &layout) override
        {
            _layout = layout;
        };
         ...
         *
         * This method returns the layout information that describes the structure of
         * the vertex data stored in the buffer.
         *
         * @return The `NxBufferLayout` object representing the vertex data layout.
         *
         * Usage:
         * - Use this information to configure vertex attribute pointers before rendering.
         */
        [[nodiscard]] NxBufferLayout getLayout() const override
        {
            return _layout;
        };
         ...
         *
         * This method returns the unique identifier assigned by OpenGL to this vertex buffer.
         *
         * @return The OpenGL buffer ID as an unsigned integer.
         *
         * Usage:
         * - Use this ID for advanced OpenGL operations that require direct buffer access.
         */
    ...
    class NxOpenGlIndexBuffer final : public NxIndexBuffer {
       public:
         ...
         * @brief Retrieves the OpenGL buffer ID.
         *
         * This method returns the unique identifier assigned by OpenGL to this index buffer.
         *
         * @return The OpenGL buffer ID as an unsigned integer.
         *
         * Usage:
