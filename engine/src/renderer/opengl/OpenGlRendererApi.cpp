...
namespace nexo::renderer {
    ...
    void NxOpenGlRendererApi::setViewport(const unsigned int x, const unsigned int y, const unsigned int width,
                                          const unsigned int height)
    {
        if (!m_initialized) THROW_EXCEPTION(NxGraphicsApiNotInitialized, "OPENGL");
        if (!width || !height) THROW_EXCEPTION(NxGraphicsApiViewportResizingFailure, "OPENGL", false, width, height);
    ...
    void NxOpenGlRendererApi::setStencilOp(const unsigned int sfail, const unsigned int dpfail,
                                           const unsigned int dppass)
    {
        if (!m_initialized) THROW_EXCEPTION(NxGraphicsApiNotInitialized, "OPENGL");
