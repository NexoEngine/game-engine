...
namespace nexo::renderer
{
                               ...
                               std::array<glm::vec3, 18>& normals)
    {
        ...
        glm::vec3 v0 = {0.0f, 0.5f, 0.0f}; // Top vertex
        glm::vec3 v1 = {-0.5f, -0.5f, -0.5f}; // Bottom-left-back
        glm::vec3 v2 = {0.5f, -0.5f, -0.5f}; // Bottom-right-back
        glm::vec3 v3 = {0.5f, -0.5f, 0.5f}; // Bottom-right-front
        glm::vec3 v4 = {-0.5f, -0.5f, 0.5f}; // Bottom-left-front
    ...
    void Renderer3D::drawPyramid(const glm::vec3& position, const glm::vec3& size, const glm::vec4& color, int entityID) const
    {
        if (!m_renderingScene)
