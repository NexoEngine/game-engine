...
namespace nexo::renderer {
	...
	constexpr int FACES_NUMBER = 20; // Number of faces for the sphere min 20 then FACES_NUMBER *= 4
	unsigned int VERTEX_NUMBER = 12; // Number of vertex for the sphere min 12 then VERTEX_NUMBER += (old) VERTEX_NUMBER + (old) FACES_NUMBER - 2
	...
	static std::vector<unsigned int> generateSphereIndices()
	{
		...
		indices.push_back(4); indices.push_back(8); indices.push_back(3);
		indices.push_back(7); indices.push_back(6); indices.push_back(0);
		indices.push_back(6); indices.push_back(9); indices.push_back(0);
		indices.push_back(11); indices.push_back(10); indices.push_back(4);
		indices.push_back(10); indices.push_back(11); indices.push_back(6);
		indices.push_back(9); indices.push_back(5); indices.push_back(2);
		indices.push_back(5); indices.push_back(9); indices.push_back(11);
		indices.push_back(8); indices.push_back(7); indices.push_back(1);
		indices.push_back(7); indices.push_back(8); indices.push_back(10);
		indices.push_back(2); indices.push_back(5); indices.push_back(3);
		indices.push_back(8); indices.push_back(1); indices.push_back(3);
		indices.push_back(9); indices.push_back(2); indices.push_back(0);
		indices.push_back(1); indices.push_back(7); indices.push_back(0);
		indices.push_back(11); indices.push_back(9); indices.push_back(6);
		indices.push_back(7); indices.push_back(10); indices.push_back(6);
		indices.push_back(5); indices.push_back(11); indices.push_back(4);
		indices.push_back(10); indices.push_back(8); indices.push_back(4);
	...
	static void loopSubdivision(std::vector<unsigned int> &indices, std::vector<glm::vec3> &vertices, const unsigned int nbSubdivisions)
	{
		for (unsigned int i = 0; i < nbSubdivisions; ++i)
		{
			...
			for (int j = 0; j < indices.size(); j += 3) {
				...
				// Triangle 2: m1, v2, m2
				newIndices.push_back(m1); newIndices.push_back(v2); newIndices.push_back(m2);
				// Triangle 3: m3, m2, v3
				newIndices.push_back(m3); newIndices.push_back(m2); newIndices.push_back(v3);
				// Triangle 4: m1, m2, m3
	...
	*/
    static void genSphereMesh(std::vector<glm::vec3> &vertices, std::vector<glm::vec2> &texCoords, std::vector<glm::vec3> &normals, std::vector<unsigned int> &indices)
    {
    	vertices = generateSphereVertices();
    	indices = generateSphereIndices();

	    loopSubdivision(indices, vertices, 2);
	...
	void Renderer3D::drawSphere(const glm::vec3 &position, const glm::vec3& size, const glm::vec4 &color, const int entityID) const
    {
        if (!m_renderingScene)
        {
        ...
        genSphereMesh(verts, texCoords, normals, indices);
    ...
    void Renderer3D::drawSphere(const glm::vec3& position, const glm::vec3& size, const glm::vec3 &rotation, const glm::vec4& color, const int entityID) const
    {
	    if (!m_renderingScene)
	    {
	        THROW_EXCEPTION(RendererSceneLifeCycleFailure, RendererType::RENDERER_3D,
    ...
    void Renderer3D::drawSphere(const glm::mat4& transform, const glm::vec4& color, const int entityID) const
    {
	    if (!m_renderingScene)
	    {
	        THROW_EXCEPTION(RendererSceneLifeCycleFailure, RendererType::RENDERER_3D,
    ...
    void Renderer3D::drawSphere(const glm::vec3& position, const glm::vec3& size, const components::Material &material, const int entityID) const
    {
	    if (!m_renderingScene)
	    {
	        THROW_EXCEPTION(RendererSceneLifeCycleFailure, RendererType::RENDERER_3D,
    ...
    void Renderer3D::drawSphere(const glm::vec3& position, const glm::vec3& size, const glm::vec3& rotation, const components::Material &material, const int entityID) const
    {
	    if (!m_renderingScene)
	    {
	        THROW_EXCEPTION(RendererSceneLifeCycleFailure, RendererType::RENDERER_3D,
    ...
    void Renderer3D::drawSphere(const glm::vec3 &position, const glm::vec3& size, const glm::quat &rotation, const components::Material &material, const int entityID) const
    {
	    if (!m_renderingScene)
	    {
	        THROW_EXCEPTION(RendererSceneLifeCycleFailure, RendererType::RENDERER_3D,
    ...
    void Renderer3D::drawSphere(const glm::mat4& transform, const components::Material &material, const int entityID) const
    {
	    if (!m_renderingScene)
	    {
	        THROW_EXCEPTION(RendererSceneLifeCycleFailure, RendererType::RENDERER_3D,
