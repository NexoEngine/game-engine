...
namespace nexo {
     ...
     * point, and spotlights) by setting up the necessary components (such as the corresponding
    ...
    class LightFactory {
       public:
         ...
         *  - components::UuidComponent
         */
        static ecs::Entity createPointLight(glm::vec3 position, glm::vec3 color = {1.0f, 1.0f, 1.0f},
                                            float linear = 0.09f, float quadratic = 0.032f);

        /**
         * @brief Creates a spotlight entity.
         *
         ...
         * @param color The RGB color of the spotlight (default is white).
         * @param linear The linear attenuation factor (default is 0.09f).
         * @param quadratic The quadratic attenuation factor (default is 0.032f).
         ...
         * @return ecs::Entity The newly created spotlight entity.
         *
         * @note Required Components added:
