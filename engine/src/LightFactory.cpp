...
namespace nexo {
    ecs::Entity LightFactory::createAmbientLight(const glm::vec3 color)
    {
        ...
        Application::m_coordinator->addComponent<components::AmbientLightComponent>(newAmbientLight,
                                                                                    newAmbientLightComponent);
    ...
    ecs::Entity LightFactory::createDirectionalLight(const glm::vec3 lightDir, const glm::vec3 color)
    {
        ...
        Application::m_coordinator->addComponent<components::DirectionalLightComponent>(newDirectionalLight,
                                                                                        newDirectionalLightComponent);
        const components::UuidComponent uuid;
        Application::m_coordinator->addComponent<components::UuidComponent>(newDirectionalLight, uuid);
        return newDirectionalLight;
    }

    ecs::Entity LightFactory::createPointLight(const glm::vec3 position, const glm::vec3 color, const float linear,
    ...
    ecs::Entity LightFactory::createSpotLight(glm::vec3 position, glm::vec3 direction, glm::vec3 color, float linear,
