...
namespace nexo::ecs {
    ...
    class SingletonComponentMixin {
       ...
       protected:
        ...
        void cacheSingletonComponent()
        {
            ...
            const std::shared_ptr<ISingletonComponent> instance =
                derived->coord->template getRawSingletonComponent<T>();
       ...
       public:
        ...
        std::conditional_t<hasReadSingletonAccess<T>(), const T&, T&> getSingleton()
        {
            ...
            if (!typedComponent) THROW_EXCEPTION(SingletonComponentNotRegistered);
    ...
    class SingletonComponentMixin<void> {
       ...
       protected:
         ...
         */
        static void initializeSingletonComponents()
        {
            // No-op method
        }
    };
