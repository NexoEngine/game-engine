...
namespace nexo::assets {
    ...
    class Texture final : public Asset<TextureData, AssetType::TEXTURE> {
       public:
         ...
         */
        explicit Texture(const std::filesystem::path &path) : Asset()
        {
         ...
         */
        Texture(const unsigned int width, const unsigned int height) : Asset()
        {
         ...
         * @throws NxTextureInvalidSize If the dimensions exceed the maximum texture size.
         */
        Texture(const uint8_t *buffer, const unsigned int width, const unsigned int height,
                const renderer::NxTextureFormat format)
            : Asset()
        {
         ...
         * @throws NxTextureInvalidSize If the image dimensions exceed the maximum texture size.
         */
        Texture(const uint8_t *buffer, const unsigned int size) : Asset()
        {
