...
//  Date:        03/12/2024
//  Description: Header file for the AssetCatalog class declaration
//
///////////////////////////////////////////////////////////////////////////////
...
namespace nexo::assets {
    ...
    class AssetCatalog {
       ...
       public:
         ...
         */
        [[nodiscard]] bool renameAsset(const GenericAssetRef& asset, const std::string& newName) const;
         ...
         * @param newName The new name for the asset.
         */
        [[nodiscard]] bool renameAsset(AssetID id, const std::string& newName) const;
         ...
         * @return GenericAssetRef A reference to the registered asset, or a null reference if the asset pointer was
         * null.
         */
         ...
         *
         * This method creates a new asset of the specified type, registers it in the catalog, and returns a reference
         * to it.
         *
        ...
        template<IsAsset AssetType>
        AssetRef<AssetType> createAsset(const AssetLocation& location,
                                        std::unique_ptr<typename AssetType::AssetDataType> assetData)
        {
