...
namespace nexo::assets {
    ...
    class InvalidAssetLocation final : public Exception {
       public:
        explicit InvalidAssetLocation(std::string_view assetLocation, std::string_view message,
    ...
    class AssetLocation {
       public:
         ...
         */
        [[nodiscard]] const AssetName& getName() const
        {
            return _name;
        }
         ...
         */
        [[nodiscard]] std::optional<std::reference_wrapper<const AssetPackName>> getPackName() const
        {
            return _packName;
        }
        ...
        void setLocation(const AssetName& name, const std::string& path,
        ...
        void setLocation(const std::string& fullLocation)
        {
            ...
            try {
                ...
                if (!extractedPackName.empty()) _packName = AssetPackName(extractedPackName);
         ...
         * @return true if the extracted asset name, pack name, and path match those of this asset location; false
         * otherwise.
         */
        bool operator==(const std::string& fullLocation) const
        {
            ...
            return _name == AssetName(extractedAssetName) && _packName == AssetPackName(extractedPackName) &&
                   _path == extractedPath;
        }
         ...
         */
        static void parseFullLocation(std::string_view fullLocation, std::string& extractedAssetName,
                                      std::string& extractedPath, std::string& extractedPackName)
        {
