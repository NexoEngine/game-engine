...
namespace nexo
{
    ...
    ecs::Entity EntityFactory3D::createCylinder(glm::vec3 pos, glm::vec3 size, glm::vec3 rotation, glm::vec4 color)
    {
        ...
        std::cout << "cylinder vao: vertices " << mesh.vao->getVertexBuffers().size()
    ...
    std::vector<components::SubMeshIndex> EntityFactory3D::processModelNode(
        ecs::Entity parentEntity, const assets::MeshNode& node)
    {
