...
namespace nexo::event {
    ...
    inline bool isKeyPressed(const int keycode)
    {
        return Input::getInstance()->isKeyPressed(keycode);
    }
    inline bool isKeyReleased(const int keycode)
    {
        return Input::getInstance()->isKeyReleased(keycode);
    }
    inline bool isKeyRepeat(const int keycode)
    {
        return Input::getInstance()->isKeyRepeat(keycode);
    }

    inline bool isMouseDown(const int button)
    {
        return Input::getInstance()->isMouseDown(button);
    }
    inline bool isMouseReleased(const int button)
    {
        return Input::getInstance()->isMouseReleased(button);
    }
