...
namespace ImNexo {
    ...
    public:
         ...
         */
        explicit StyleGuard(ImGuiCol_ col, ImU32 color) {
            if (color != 0) {
         ...
         */
        StyleGuard& push(ImGuiCol_ col, ImU32 color) {
            if (color != 0) {
                m_colorIndices.push_back(col);
                ImGui::PushStyleColor(col, color);
            }
    ...
    public:
         ...
         */
        explicit StyleVarGuard(ImGuiStyleVar_ var, ImVec2 value) {
            m_varCount++;
         ...
         */
        explicit StyleVarGuard(ImGuiStyleVar_ var, float value) {
            m_varCount++;
            ImGui::PushStyleVar(var, value);
        }
         ...
         * @return Reference to this guard for method chaining
         */
        StyleVarGuard& push(ImGuiStyleVar_ var, ImVec2 value) {
            m_varCount++;
            ImGui::PushStyleVar(var, value);
            return *this;
        }
         ...
         * @return Reference to this guard for method chaining
         */
        StyleVarGuard& push(ImGuiStyleVar_ var, float value) {
            m_varCount++;
            ImGui::PushStyleVar(var, value);
            return *this;
        }
    ...
    public:
         ...
         */
        explicit FontScaleGuard(float scale) : m_scale(scale) {
