...
namespace ImNexo {
       ...
       public:
        ...
        StyleGuard& operator=(StyleGuard&& other) noexcept
        {
            if (this != &other) {
                ...
                if (!m_colorIndices.empty()) ImGui::PopStyleColor(static_cast<int>(m_colorIndices.size()));
    ...
    class FontScaleGuard {
       public:
         ...
         */
        FontScaleGuard(FontScaleGuard&& other) noexcept : m_active(other.m_active)
        {
        ...
        FontScaleGuard& operator=(FontScaleGuard&& other) noexcept
        {
            if (this != &other) {
                ...
                if (m_active) ImGui::SetWindowFontScale(1.0f);
