...
namespace ImNexo {
     ...
     */
    void CenteredIcon(const std::string& icon, const ImVec2& p_min, const ImVec2& p_max, ImU32 color,
                      float scale = 1.0f, float verticalPosition = 0.5f, float horizontalPosition = 0.5f,
                      ImFont* font = nullptr);
     ...
     */
    void WrappedCenteredText(const std::string& text, const ImVec2& p_min, const ImVec2& p_max, ImU32 color,
     ...
     */
    bool Button(const std::string& label, ButtonTypes type, const ImVec2& size = ImVec2(0, 0), ImU32 bg = 0,
                ImU32 bgHovered = 0, ImU32 bgActive = 0, ImU32 txtColor = 0);
     ...
     * @return true if the button was clicked; false otherwise.
     */
    bool Button(const std::string& label, const ImVec2& size = ImVec2(0, 0), ImU32 bg = 0, ImU32 bgHovered = 0,
                ImU32 bgActive = 0, ImU32 txtColor = 0);
     ...
     */
    void ButtonBorder(ImU32 borderColor, ImU32 borderColorHovered, ImU32 borderColorActive, float rounding = 2.0f,
                      ImDrawFlags flags = 0, float thickness = 3.0f);
     ...
     * @param thickness The thickness of the border.
     */
    void ButtonInnerBorder(ImU32 borderColor, ImU32 borderColorHovered, ImU32 borderColorActive, float rounding = 2.0f,
                           ImDrawFlags flags = 0, float thickness = 3.0f);
     ...
     */
    bool DragFloat(const std::string& label, float* values, float speed, float min, float max,
                   const std::string& format, ImU32 bg = 0, ImU32 bgHovered = 0, ImU32 bgActive = 0,
                   ImU32 textColor = 0);
     ...
     */
    void CustomSeparatorText(const std::string& text, float textPadding, float leftSpacing, float thickness,
                             ImU32 lineColor, ImU32 textColor);
     ...
     */
    void Image(ImTextureID user_texture_id, const ImVec2& image_size, const ImVec2& uv0 = ImVec2(0, 1), // Flipped Y
     ...
     * @param[in] tint_col         The tint color applied to the image.
     */
    bool ImageButton(const char* str_id, ImTextureID user_texture_id, const ImVec2& image_size,
