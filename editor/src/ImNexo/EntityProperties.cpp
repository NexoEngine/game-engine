...
namespace ImNexo {
    ...
    void DirectionalLight(nexo::components::DirectionalLightComponent &directionalComponent)
    {
        ...
        if (ImGui::BeginTable("InspectorDirectionTable", 4, ImGuiTableFlags_SizingStretchProp)) {
                    ...
                    nexo::components::TransformComponent &pointTransform)
    {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_CellPadding, ImVec2(5.0f, 10.0f));
        if (ImGui::BeginTable("InspectorPointTable", 4, ImGuiTableFlags_SizingStretchProp)) {
            ImGui::TableSetupColumn("##Label",
                                    ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ImGui::TableSetupColumn("##X", ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ImGui::TableSetupColumn("##Y", ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
                   ...
                   nexo::components::TransformComponent &spotTransform)
    {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_CellPadding, ImVec2(5.0f, 10.0f));
        if (ImGui::BeginTable("InspectorSpotTable", 4, ImGuiTableFlags_SizingStretchProp)) {
            ImGui::TableSetupColumn("##Label",
                                    ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ImGui::TableSetupColumn("##X", ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ImGui::TableSetupColumn("##Y", ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
    ...
    {
        ImGui::PushStyleVar(ImGuiStyleVar_CellPadding, ImVec2(5.0f, 10.0f));
        if (ImGui::BeginTable("CameraInspectorViewPortParams", 4, ImGuiTableFlags_SizingStretchProp)) {
            ImGui::TableSetupColumn("##Label",
                                    ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ImGui::TableSetupColumn("##X", ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ImGui::TableSetupColumn("##Y", ImGuiTableColumnFlags_WidthStretch | ImGuiTableColumnFlags_NoHeaderLabel);
            ...
            const bool toResize = RowDragFloat2("Viewport size", "W", "H", &viewPort.x, -FLT_MAX, FLT_MAX, 1.0f, badgeColors,
                                          textBadgeColors, disabled);
            ...
            // Lock button
            const std::string lockBtnLabel = !cameraComponent.viewportLocked ? ICON_FA_LOCK "##ViewPortSettings" :
                                                                               ICON_FA_UNLOCK "##ViewPortSettings";
    ...
    {
        ImGui::PushStyleVar(ImGuiStyleVar_CellPadding, ImVec2(5.0f, 10.0f));
        if (ImGui::BeginTable("InspectorControllerTable", 2, ImGuiTableFlags_SizingStretchProp)) {
            ...
            const std::vector<nexo::ecs::Entity> &entities = nexo::Application::m_coordinator->getAllEntitiesWith<
                nexo::components::TransformComponent, nexo::ecs::Exclude<nexo::components::CameraComponent>,
            ...
            RowEntityDropdown(
                "Target Entity", cameraTargetComponent.targetEntity, entities, [&selector](const nexo::ecs::Entity e) {
