...
namespace nexo::editor {
    ...
    class ThumbnailCache {
       public:
         ...
         */
        unsigned int getThumbnail(const assets::GenericAssetRef& assetRef, const glm::vec2& size = {128, 128});
       ...
       private:
         ...
         * @return OpenGL texture ID of the generated thumbnail.
         */
        unsigned int createTextureThumbnail(const assets::AssetRef<assets::Texture>& textureRef, const glm::vec2& size);

        /**
         * @brief Internal helper to generate a model thumbnail.
         *
         * Caches the model directly if loaded or creates a ScenePreview if needed.
         * @param modelRef Reference to the model.
         * @param size Desired thumbnail size.
         * @return OpenGL model ID of the generated thumbnail.
         */
        unsigned int createModelThumbnail(const assets::AssetRef<assets::Model>& modelRef, const glm::vec2& size);
