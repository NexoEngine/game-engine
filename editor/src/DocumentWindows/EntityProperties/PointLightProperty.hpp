...
namespace nexo::editor {
    class PointLightProperty final : public AEntityProperty {
       public:
         ...
         * The interface allows for color adjustment, position modification via a draggable table, and max distance
         * tuning using a slider, which in turn updates the light's attenuation coefficients.
         *
