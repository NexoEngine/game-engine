...
namespace nexo::editor {
    class CameraProperty final : public AEntityProperty {
       public:
         ...
         * camera settings. The UI includes controls for modifying viewport dimensions (with a lock toggle), field of
         * view, near plane, far plane, and the clear color using ImGui.
         *
