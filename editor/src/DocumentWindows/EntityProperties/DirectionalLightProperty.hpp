...
namespace nexo::editor {
    class DirectionalLightProperty final : public AEntityProperty {
       public:
         ...
         * editor uses a customizable picker while the direction is adjusted via draggable float inputs arranged in a
         * table.
         *
