...
namespace nexo::editor {
    ...
    class RenderProperty final : public AEntityProperty {
       public:
         ...
         * If a preview scene hasn’t been generated yet, it is created for the specified dimensions. When the user
         * confirms by clicking "OK", the material is linked to the entity's render component and the preview scene is
         * cleaned up; clicking "Cancel" simply deletes the preview scene.
         *
