    ...
    void PointLightProperty::show(const ecs::Entity entity)
    {
        ...
        if (ImNexo::Header("##PointNode", "Point light")) {
            ...
            if (ImNexo::isItemActivated()) {
                ...
                auto pointAction         = std::make_unique<ComponentChangeAction<components::PointLightComponent>>(
                    entity, beforeStatePoint, afterStatePoint);
                auto transformAction = std::make_unique<ComponentChangeAction<components::TransformComponent>>(
                    entity, beforeStateTransform, afterStateTransform);
