    ...
    class PopupManager {
       public:
        ...
        void openPopupWithCallback(const std::string &popupName, PopupCallback callback,
                                   const ImVec2 &popupSize = ImVec2(0, 0));
       ...
       private:
        /**
         * @brief Custom hasher for string_view to enable heterogeneous lookup in unordered_map.
         *
         * This struct provides a hash function for std::string_view, allowing
         * the unordered_map to perform lookups using string_view keys without
         * needing to create temporary std::string objects.
         */
